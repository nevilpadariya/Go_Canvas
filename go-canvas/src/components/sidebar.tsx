...
function Sidebar(){
    return(
        ...
        <nav className="navbar">
            ...
            <li><NavLink className="nav-link" onClick={e => document.body.classList.remove('sidebar-open')} to={"/courses"} title="Courses"> <img src={ordersIcon} alt="courses" className="default-icon" /><img src={ordersactive} alt="courses" className="active-icon" /> Courses <SideDrawer></SideDrawer></NavLink></li>
